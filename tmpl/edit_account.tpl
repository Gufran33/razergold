...
<tr>
 ...
 <td><input type=text name=fullname value='{$userinfo.name|escape:"quotes"}' class="form-control">
</tr>
{if $settings.use_user_location}
<tr>
 <td>Your Address:</td>
 <td><input type=text name=address value="{$userinfo.address|escape:"quotes"}" class="form-control"></td>
</tr>
<tr>
 <td>Your City:</td>
 <td><input type=text name=city value="{$userinfo.city|escape:"quotes"}" class="form-control"></td>
</tr>
<tr>
 <td>Your State:</td>
 <td><input type=text name=state value="{$userinfo.state|escape:"quotes"}" class="form-control"></td>
</tr>
<tr>
 <td>Your Zip:</td>
 <td><input type=text name=zip value="{$userinfo.zip|escape:"quotes"}" class="form-control"></td>
</tr>
<tr>
 <td>Your Country:</td>
 <td>
...
<tr>
 ...
 <td>{if $settings.usercanchangeemail == 1}<input type=text name=email value='{$userinfo.email|escape:"quotes"}' class="form-control">{else}{$userinfo.email}{/if}</td>
</tr>
{if $settings.use_rcb}
<tr>
 <td>Your RCB Percent:</td>
 <td>{if $userinfo.rcb_lock}{$userinfo.rcb}%{else}<input type=text class="form-control" name="rcb" value="{$frm.rcb|default:$userinfo.rcb|number_format:2}">{/if}</td>
</tr>
{/if}
