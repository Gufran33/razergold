...
<!-- Search Widget -->
<div class="widget widget-search">
<h4 class="widget-title">Payment System</h4>
<table cellspacing=0 cellpadding=2 border=0>
...
<div class="widget widget-search">
<h4 class="widget-title">Security System</h4>
 <table cellspacing=0 cellpadding=2 border=0>  
<tr>
...
<tr>
 <td colspan=2><input type=checkbox name=agree value=1 style="width: 20px;
    height: 20px;" {if $frm.agree}checked{/if} > I agree with <a href="{"?a=rules"|encurl}">Terms and conditions</a></td>
</tr>
